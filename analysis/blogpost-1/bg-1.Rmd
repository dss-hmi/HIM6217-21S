...
read_chunk("./analysis/blogpost-1/bg-1.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r c1, echo = echo_chunks, results='show', message=message_chunks}
```
...
```{r c2, echo = echo_chunks, results='show', message=message_chunks}
```
